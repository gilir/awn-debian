/* test-vala-awn-dialog.c generated by valac 0.10.4, the Vala compiler
...
GType awn_test_get_type (void) G_GNUC_CONST;
enum  {
...
static gboolean _awn_test_on_quit_gtk_widget_delete_event (GtkWidget* _sender, GdkEvent* event, gpointer self) {
	gboolean result;
	result = awn_test_on_quit (self, _sender, event);
	return result;
}
...
AwnTest* awn_test_construct (GType object_type) {
	...
	GtkLabel* label;
	GtkLabel* _tmp0_;
	self = (AwnTest*) g_object_new (object_type, "type", GTK_WINDOW_TOPLEVEL, "title", "Awn Dialog Test (Vala)", NULL);
	label = NULL;
...
GType awn_test_get_type (void) {
	static volatile gsize awn_test_type_id__volatile = 0;
	if (g_once_init_enter (&awn_test_type_id__volatile)) {
		...
		GType awn_test_type_id;
		awn_test_type_id = g_type_register_static (GTK_TYPE_WINDOW, "AwnTest", &g_define_type_info, 0);
		g_once_init_leave (&awn_test_type_id__volatile, awn_test_type_id);
	}
	return awn_test_type_id__volatile;
}
